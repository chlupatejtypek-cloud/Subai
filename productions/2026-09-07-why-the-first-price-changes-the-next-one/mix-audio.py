...
cues=[(.03,'zoom-in-original.wav',.024,'Opening push, original procedural synthesis'),(c['study']+.05,'open_001.ogg',.020,'Research panel, Kenney Interface Sounds CC0'),(c['fact']+.07,'drop_001.ogg',.026,'Fact card landing, Kenney CC0'),(c['guess']+.07,'drop_002.ogg',.023,'Guess card landing, Kenney CC0'),(c['ending']+.04,'zoom-out-original.wav',.022,'Return to same cafe/pull out, original procedural synthesis')]
...
sf.write(str(p/'output/sfx-preview.wav'),sampler,sr,subtype='PCM_16');print('Five restrained cues mixed; optional six-second preview created.')
