...
raw=buf.getvalue();count=math.ceil(len(raw)/4000000);final=p/'output/plan-trigger-final.mp4';uploads=[final]
...
results=[];folder='subai/productions/stiles-psychology/2026-09-10-plan-trigger'
for f in uploads:
