...
raw=buf.getvalue();count=math.ceil(len(raw)/4000000);final=p/'output/reference-frame-final.mp4';uploads=[final]
...
results=[];folder='subai/productions/stiles-psychology/2026-09-09-reference-frame'
for f in uploads:
