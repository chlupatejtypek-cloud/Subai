...
raw=buf.getvalue();count=math.ceil(len(raw)/4000000);final=p/'output/restart-note-final.mp4';uploads=[final]
...
results=[];folder='subai/productions/stiles-psychology/2026-09-08-restart'
for f in uploads:
