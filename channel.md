...
Read `VISUAL-EDITORIAL.md` before topic selection or scripting. Research FIRST; an everyday topic needs a non-obvious, useful, evidence-backed angle. Reject trivia and generic advice even if a calendar title exists. Hyperframes is being evaluated for smoothly animated cards, graphs and explanatory UI; no production-readiness claim until a local render and audiovisual QA pass.
