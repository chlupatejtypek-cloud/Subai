...
Latest editorial contract: `VISUAL-EDITORIAL.md`. Maximum duration 60s, research before script, dynamic semantic pacing, stable source art and optional useful UI. Hyperframes docs reviewed; integration/render verification pending. Preserve existing final/publication states; do not auto-publish the rejected silence edit.
